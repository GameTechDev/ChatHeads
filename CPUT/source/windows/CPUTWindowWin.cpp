...
#include "imgui.h" // Allowing Imgui to access keyevents
...
void CPUTWindowWin::SetWindowTitle(std::wstring title)
{
    ...
    {
		{
			...
			if (wParam == VK_CONTROL) io.KeyCtrl = true;
			else if (wParam == VK_MENU) io.KeyAlt = true;
			else if (wParam == VK_SHIFT) io.KeyShift = true;
		}
