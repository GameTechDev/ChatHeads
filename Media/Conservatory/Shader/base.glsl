...
vec4 DIFFUSE( )
{
    return texture(texture_DM,(((outUV0)) *(10.000000)) );
}

// -------------------------------------
vec4 SPECULAR( )
{
    return texture(texture_SM,(((outUV0)) *(10.000000)) );
}

// -------------------------------------
float SPECULARITY( )
{
    return ((( (texture(texture_ST,(((outUV0)) *(10.000000)) ) ).r )) *(128.000000)) +(4.000000);
}

// -------------------------------------
vec4 NORMALS( )
{
    return texture(texture_NM,(((outUV0)) *(10.000000)) ) * 2.0 - 1.0;
}
