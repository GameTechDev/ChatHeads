...
// -------------------------------------
    ...
    Texture2D texture_AO : register( t2 );
#else
texture2D texture_DM < string Name = "texture_DM"; string UIName = "texture_DM"; string ResourceType = "2D";>;
sampler2D SAMPLER0 = sampler_state{ texture = (texture_DM); MinFilter = Linear; MagFilter = Linear; MipFilter = Linear; };
bool texture_DMsRGB = true;
texture2D texture_SM < string Name = "texture_SM"; string UIName = "texture_SM"; string ResourceType = "2D";>;
sampler2D SAMPLER1 = sampler_state{ texture = (texture_SM); MinFilter = Linear; MagFilter = Linear; MipFilter = Linear; };
bool texture_SMsRGB = true;
texture2D texture_AO < string Name = "texture_AO"; string UIName = "texture_AO"; string ResourceType = "2D";>;
sampler2D SAMPLER2 = sampler_state{ texture = (texture_AO); MinFilter = Linear; MagFilter = Linear; MipFilter = Linear; };
...
#else
SRGB2Linear(tex2D( SAMPLER0, ((input.UV0)) ), texture_DMsRGB)
#endif
;
}
...
#else
SRGB2Linear(tex2D( SAMPLER1, ((input.UV0)) ), texture_SMsRGB)
#endif
;
}
...
#else
SRGB2Linear(tex2D( SAMPLER2, ((input.UV1)) ), texture_AOsRGB)
#endif
;
}
...
{
    return float4(0.350000, 0.350000, 0.350000, 0.350000);
}
