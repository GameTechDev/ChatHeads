...
float4 DIFFUSE( PS_INPUT input )
{
    return 
#ifdef _CPUT
texture_DM.Sample( SAMPLER0, (((input.UV0)) *(10.000000)) )
#else
SRGB2Linear(tex2D( SAMPLER1, (((input.UV0)) *(10.000000)) ), texture_DMsRGB)
#endif
;
}
...
float4 SPECULAR( PS_INPUT input )
{
    return 
#ifdef _CPUT
texture_SM.Sample( SAMPLER0, (((input.UV0)) *(10.000000)) )
#else
SRGB2Linear(tex2D( SAMPLER2, (((input.UV0)) *(10.000000)) ), texture_SMsRGB)
#endif
;
}
...
float4 SPECULARITY( PS_INPUT input )
{
    return ((( (
#ifdef _CPUT
texture_ST.Sample( SAMPLER0, (((input.UV0)) *(10.000000)) )
#else
SRGB2Linear(tex2D( SAMPLER0, (((input.UV0)) *(10.000000)) ), texture_STsRGB)
#endif
...
#else
SRGB2Linear(tex2D( SAMPLER3, (((input.UV0)) *(10.000000)) ), texture_NMsRGB)
#endif
 * 2.0 - 1.0;
}
