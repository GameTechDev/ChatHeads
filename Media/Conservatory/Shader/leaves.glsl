...
uniform sampler2D texture_EM;
// -------------------------------------
vec4 DIFFUSE( )
{
    return texture(texture_DM,((outUV0)) );
}

// -------------------------------------
vec4 SPECULARTMP( )
{
    return texture(texture_SM,((outUV0)) );
}

// -------------------------------------
float SPECULARITY( )
{
    return ((( (texture(texture_ST,((outUV0)) ) ).r )) *(128.000000)) +(4.000000);
}

// -------------------------------------
vec4 NORMALS( )
{
    return texture(texture_NM,((outUV0)) ) * 2.0 - 1.0;
}

// -------------------------------------
vec4 EMISSIVETMP( )
{
    return texture(texture_EM,((outUV0)) );
}

// -------------------------------------
vec4 EMISSIVE( )
{
    return (EMISSIVETMP()) *(0.000000);
}

// -------------------------------------
vec4 SPECULAR( )
{
    return (SPECULARTMP()) *(5.000000);
}
...
vec4 CLIPTHRESHOLD( )
{
    return vec4(0.500000, 0.500000, 0.500000, 0.500000);
}
