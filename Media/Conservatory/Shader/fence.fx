...
float4 SPECULARTMP( PS_INPUT input )
{
    return 
#ifdef _CPUT
texture_SM.Sample( SAMPLER0, (((input.UV0)) *(2.000000)) )
#else
SRGB2Linear(tex2D( SAMPLER2, (((input.UV0)) *(2.000000)) ), texture_SMsRGB)
#endif
;
}
...
float4 SPECULARITY( PS_INPUT input )
{
    return ((( (
#ifdef _CPUT
texture_ST.Sample( SAMPLER0, (((input.UV0)) *(2.000000)) )
#else
SRGB2Linear(tex2D( SAMPLER0, (((input.UV0)) *(2.000000)) ), texture_STsRGB)
#endif
