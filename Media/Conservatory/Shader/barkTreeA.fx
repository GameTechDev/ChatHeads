...
sampler2D SAMPLER2 = sampler_state{ texture = (texture_NM); MinFilter = Linear; MagFilter = Linear; MipFilter = Linear; };
...
#else
SRGB2Linear(tex2D( SAMPLER2, ((input.UV0)) ), texture_NMsRGB)
#endif
 * 2.0 - 1.0;
}
